...
The original is made by [ckaindel](https://github.com/ckaindel/island-generator/commits?author=ckaindel). All credits go to them. I simply just refactored the code to work with Godot 4.x syntax.

The [original description](https://github.com/ckaindel/island-generator/blob/main/README.md):
